      ...
      <div className="space-y-12">
        <section className="prose dark:prose-invert max-w-none">
          ...
          <p className="leading-7">
            Xeref-Claw is part of the <strong>xeref.ai</strong> ecosystem, designed to democratize access to powerful, autonomous AI agents. 
            Inspired by the <em>OpenClaw</em> project concept, this tool bridges the gap between 
